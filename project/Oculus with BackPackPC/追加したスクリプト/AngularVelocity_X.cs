...
public class AngularVelocity_X : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 pointAlongLine = System.Math.Abs(manager.VectorOfAngularVelocity.x) * Vector3.Normalize(pointB - pointA) / 500 + pointA;
