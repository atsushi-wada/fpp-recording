...
public class AngularVelocity_Z : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 pointAlongLine = System.Math.Abs(manager.VectorOfAngularVelocity.z) * Vector3.Normalize(pointB - pointA) / 500 + pointA;
